...
import org.example.listener.TranslateListener;
...
public class TranslatorAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        HintManager.getInstance().showInformationHint(editor, transResult);
        TranslatorTextProvider.items.add(text);
        TranslatorTextProvider.items.add(transResult);
    }
}
